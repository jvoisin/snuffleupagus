...
--FILE--
--EXPECT--
PHP Fatal error:  [snuffleupagus][config] Invalid var name: $i$$!@#. in Unknown on line 0
PHP Fatal error:  [snuffleupagus][config] Invalid value '$i$$!@#->qwe' for `var` on line 1 in Unknown on line 0
