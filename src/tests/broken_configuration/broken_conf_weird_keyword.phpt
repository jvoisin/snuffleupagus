...
--FILE--
--EXPECTF--
Fatal error: [snuffleupagus][0.0.0.0][config][log] Unexpected keyword 'not_a_valid_keyword' in %a/config/broken_conf_weird_keyword.ini on line 1 in Unknown on line 0
