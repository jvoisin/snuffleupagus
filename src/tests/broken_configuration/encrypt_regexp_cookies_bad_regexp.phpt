...
Fatal error: [snuffleupagus][0.0.0.0][config] Failed to compile '^super_co[a-z+$': missing terminating ] for character class on line 2. in Unknown on line 0

Fatal error: [snuffleupagus][0.0.0.0][config] '.name_r()' is expecting a valid regexp, and not '"^super_co[a-z+$"' on line 2 in Unknown on line 0
